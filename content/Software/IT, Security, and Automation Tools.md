...
modified: 2025-04-29T17:26:22-05:00
Needs Revised: true
...
- **Task Scheduler** - Automated recurring scripts and system tasks in my [[Homelab|homelab]].
...
- **Remote Desktop (RDP)** - Used daily at the [[City of Fort Smith - IT Support Specialist|City of Fort Smith]]. for troubleshooting.  
- Also used **TeamViewer**, **AnyDesk**, and **Chrome Remote Desktop** during my time running [[Owner at Kelly Computer Services|Kelly Computer Services]].  
...
- **Hyper-V**, **VMware (Workstation/ESXi)**, **VirtualBox** - Used for sandboxing, server management at the [[City of Fort Smith - IT Support Specialist|City of Fort Smith]], OS testing, and cybersecurity/[[Homelab|home]] labs.  
- **Docker** - Used lightweight containers in labs and automation practice.
...
- **Private Internet Access (PIA)** - Used for personal browsing security and research purposes.

---

## 💻 Scripting Languages

- **PowerShell** - Built automation scripts to streamline technician tasks and [[Medtronic - Technical User Support Analyst|help deploy systems at Medtronic]].  
- **Bash** 
- **Python** - Extensive use in personal and entrepreneurial projects in conjunction with **Selenium** for web scraping as well as data collection and manipulation. 
- **Java** - Used for [[Education/index|coursework]].
- **JavaScript** - Used for coursework, automation, and data parsing tasks.  
- **AutoHotKey**, **AutoIT** - Built small desktop automations during my time at the [[City of Fort Smith - IT Support Specialist|City of Fort Smith]].
- **HTML/CSS** - Used in CMS customization and templating for client sites at [[Owner at Fancy Fox Creative|my design studio]].  
- **SQL** - Wrote queries for coursework ranging from reporting and dashboard development.

---

## 🔄 Workflow Automation Tools

- **Zapier**, **Make (Integromat)**, **IFTTT** - Used to automate campaign data, client reporting, and inter-app workflows.
