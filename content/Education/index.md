...
- **Outstanding Networking Graduate of the Year**  
	Awarded as the **only recipient** among graduating students in the **Information Technology - Networking** program, recognizing my academic excellence, technical proficiency, and dedication to the field.
- **Graduate Cum Laude** (3.7 GPA)  
...
- Developed a **detailed network layout**, including **bandwidth requirements, server specifications, and geographical placement** of cameras and streaming equipment.
