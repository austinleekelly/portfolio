...
_The Linux Operating System Security course introduces key security features and tools within Linux, focusing on Red Hat Linux. The course is designed for IT and security managers, as well as system administrators, to enhance their knowledge of configuring and hardening Linux systems._

## 📂 Certification Overview

- **🏆 Certification:** Linux Operating System Security
    
- **🎓 Issuing Organization:** [Department of Homeland Security](https://www.dhs.gov/)
    
- **📆 Date Earned:** 01/03/2018
...
- **Technical Skills:** Linux security, system hardening, malware analysis, incident response
...
- **Verification Link:** [[(DHS) Linux Operating System Security - 9 Hours.pdf|Linux Operating System Security]]