---
created: 2025-04-04T18:22:44-05:00
...
_The Security and DNS course covers the principles and security standards of Domain Name System (DNS), focusing on name resolution, DNSSEC, and techniques for securing zone transfers. The course also explores the challenges of migrating to DNSSEC and implementing security practices to protect DNS infrastructure from cyber threats._

## 📂 Certification Overview

- **🏆 Certification:** Security and DNS
...
- **Technical Skills:** DNS security, DNSSEC implementation, TSIG, name resolution, zone transfer security
...
- **Verification Link:** [[(DHS) Security and DNS - 1 Hour.pdf|Security and DNS]]